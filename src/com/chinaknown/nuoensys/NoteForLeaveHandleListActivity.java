...
public class NoteForLeaveHandleListActivity extends Activity implements LoadingListener{
	...
	private void back() {
		this.finish();
		Log.i("a", "清空数据");
		nfls = new ArrayList<NoteForLeave>();
	...
	private void init() {
		...
		listAdapter = new NoteForLeaveApplyListViewAdapter(this, nfls, false);
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Intent intent = new Intent(NoteForLeaveHandleListActivity.this, NoteForLeaveHandleDetailsActivity.class);
	...
	public void doLoadMore() {
		...
		new Thread(new Runnable() {
			...
			@Override
			public void run() {
				List<NoteForLeave> nfls = NoteForLeaveHttpUtils.loadNoteForLeaveHandleList(pageindex, employee.getUserid(), 0);
